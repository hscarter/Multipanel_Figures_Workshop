...
```{r, eval=F}
ggplot(pumpkin_varieties, aes(days_mature, variety))+
  geom_col()+
  theme_minimal()+
  labs(y = "Variety", x = "Days to maturity")

ggplot(pumpkin_varieties, aes(size_lbs, variety))+
  geom_col()+
  theme_minimal()+
  labs(y = "Variety", x = "Size at maturity (lbs)")

ggplot(pumpkin_varieties[pumpkin_varieties$powdery_hybrid == "yes",], aes(days_mature, size_lbs))+
  geom_point()+
  theme_minimal()+
  labs(x = "Days to maturity", y = "Size at maturity (lbs)")

ggplot(pumpkin_varieties[pumpkin_varieties$powdery_hybrid == "no",], aes(days_mature, size_lbs))+
  geom_point()+
  theme_minimal()+
  labs(x = "Days to maturity", y = "Size at maturity (lbs)")
```
...
To add labels with patchwork, you use the plot_layout() and plot_annotation() functions.

```{r}
hybrid_grow | nonhybrid_grow + plot_layout(tag_level = "new") + plot_annotation(tag_levels = "A")
```
